...
from lib.dataprep.split import raise_error_train_val_dates, get_cv_cutoffs, raise_error_cv_dates
...
@pytest.mark.parametrize(
    "dates",
    [
        (make_dates_test(train_start='2020-01-01', train_end='2021-01-01', n_folds=12, folds_horizon=30, freq='D')),
        (make_dates_test(train_start='2020-01-01', train_end='2021-01-01', n_folds=5, folds_horizon=3, freq='4D')),
        (make_dates_test(train_start='2020-01-01', train_end='2021-01-01', n_folds=50, folds_horizon=1, freq='W')),
        (make_dates_test(train_start='2020-01-01', train_end='2020-01-02', n_folds=7, folds_horizon=3, freq='H')),
    ],
)
...
@pytest.mark.parametrize(
    "dates",
    [
        (make_dates_test(train_start='1900-01-01', train_end='2021-01-01', n_folds=5, folds_horizon=3, freq='Y')),
        (make_dates_test(train_start='1950-01-01', train_end='2021-01-01', n_folds=5, folds_horizon=4, freq='Q')),
        (make_dates_test(train_start='1970-01-01', train_end='2021-01-01', n_folds=5, folds_horizon=6, freq='M')),
        (make_dates_test(freq='W')),
        (make_dates_test(freq='D')),
        (make_dates_test(train_start='2021-01-01', train_end='2021-01-30', n_folds=5, folds_horizon=12, freq='H')),
    ],
)
